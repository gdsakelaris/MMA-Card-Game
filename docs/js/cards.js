        ...
        const cardDatabase = {
            ...
            techniques: [
                ...
                { id: 'tech_cross',    name: 'Power Cross',        type: 'technique', subtype: 'strike', strikeType: 'punch', energy: 2, damage: 4, copies: 2, ignoresReduce: true, canKnockdown: true, effect: 'Strike: 4 + Striking. Straight power — a Block can\'t soften it (only a full Parry/Slip stops it). A clean shot landing 8+ on its own power (not combo) knocks down.' },
                ...
                { id: 'tech_uppercut', name: 'Uppercut',           type: 'technique', subtype: 'strike', strikeType: 'punch', energy: 3, damage: 5, copies: 2, clinchLegal: true, canKnockdown: true, effect: 'Strike: 5 + Striking. A short inside punch — also legal in the clinch. A clean shot landing 8+ on its own power (not combo) knocks down.' },
                { id: 'tech_hook',     name: 'Heavy Hook',         type: 'technique', subtype: 'strike', strikeType: 'punch', energy: 3, damage: 6, copies: 2, canKnockdown: true, effect: 'Strike: 6 + Striking. Loads up: a clean shot landing 8+ on its own power (not combo) scores a KNOCKDOWN.' },
